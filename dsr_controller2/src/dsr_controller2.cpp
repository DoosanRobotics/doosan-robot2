...
auto set_safety_mode = [this](const std::shared_ptr<dsr_msgs2::srv::SetSafetyMode::Request> req, std::shared_ptr<dsr_msgs2::srv::SetSafetyMode::Response> res) -> void
{
...
auto torque_rt_cb = [this](const std::shared_ptr<dsr_msgs2::msg::TorqueRtStream> msg) -> void
{
  ...
  m_nh_srv_set_safety_monde          = get_node()->create_service<dsr_msgs2::srv::SetRobotControl>("system/set_safety_monde", set_safety_monde_cb);
