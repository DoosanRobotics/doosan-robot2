...
def main(args=None):
        ...
        try:
                ...
                from DSR_ROBOT2 import DR_LINE, DR_CIRCLE, DR_BASE, DR_TOOL, DR_AXIS_X, DR_AXIS_Z, DR_MV_MOD_ABS, ROBOT_MODE_AUTONOMOUS, SAFETY_MODE_MANUAL, SAFETY_MODE_EVENT_MOVE, DR_SERVO_OVERRIDE, DR_SERVO_QUEUE
        ...
        servoj(posj(0,0,0,0,0,0), vel=[100.0]*6, acc=[100.0]*6, time=2.0)
        time.sleep(2)
        servoj(posj(0,0,0,0,90,0), vel=[100.0]*6, acc=[100.0]*6, time=2.0)
        time.sleep(2)
        servoj(posj(0,0,0,0,90,0),vel=[0,0,0,0,50,50], acc=[0,0,0,0,50,50],time=2.0)
        time.sleep(2)
        servoj(posj(0,0,0,0,0,0),vel=[0,0,0,0,50,50], acc=[0,0,0,0,50,50],time=2.0)
        time.sleep(2)
        ...
        while i < 1:
                ...
                for i in range(90):
                        servoj(posj(0,0,0,0,i,0),vel=[100.0]*6, acc=[100.0]*6,time=0.2, mode= DR_SERVO_OVERRIDE)
                        time.sleep(0.1)
                time.sleep(0.5)
                # movej(p1, vel=100, acc=100)
                time.sleep(1.5)
                for i in range(90):
                        servoj(posj(0,0,0,0,90-i,0),vel=[0.0]*6, acc=[0.0]*6,time=0.2, mode= DR_SERVO_OVERRIDE)
                        time.sleep(0.1)
                time.sleep(1.0)                

                for i in range(90):
                        servoj(posj(0,0,0,0,i,0),vel=[100.0]*6, acc=[100.0]*6,time=0.2, mode= DR_SERVO_QUEUE)
                        time.sleep(0.1)
                time.sleep(0.5)
                # movej(p1, vel=100, acc=100)
                time.sleep(1.5)
                for i in range(90):
                        servoj(posj(0,0,0,0,90-i,0),vel=[0.0]*6, acc=[0.0]*6,time=0.2, mode= DR_SERVO_QUEUE)
                        time.sleep(0.1)
                time.sleep(1.0)           
